		...
		<div className="ml-auto mr-auto max-w-[1200px] p-3">
			<section>
				...
				<span>
					...
					erfarenhet, skapar gemenskap i klubben och ger mer engagemang än att sälja lotter och
			...
			<section>
				...
				<ul className="list-disc pl-6">
					<li>
						...
						Betalas in i januari varje år. Börjar man träna senare under året betalas avgiften då.
						Från och med den 1 november täcker medlemsavgiften även kommande år. Medlemsavgiften
						täcker försäkringar. Det är därför viktigt att den betalas. Stödmedlemmar betalar
						medlemsavgiften.
					</li>
					<li>
						<strong>Nybörjare (första terminen):</strong> 700 kr <strong>per person.</strong> I
						nybörjaravgiften ingår medlemsavgiften (200:-)
					</li>
					<li>
						<strong>Terminsavgift:</strong> 1000:- / per termin för samtliga. (Vår/Höst)
					</li>
					<li>
						<strong>Familj</strong>: 1800:- för en familj med 2 eller fler medlemmar, från och med
						andra termin. (Vår/Höst)
					</li>
					<li>
						<strong>Judo4Balance, Falltrygghet för äldre:</strong> 800 kr per person,
						medlemsavgiften ingår (200:-)
					</li>
					<li>
						<strong>Stor & Liten:</strong> 800 kr per vuxen + barn, medlemsavgiften ingår (200: -
						per person)
					</li>
					<li>
						<strong>Tävlingar/läger:</strong> Prioriterade tävlingar och läger betalar klubben
						tävlingsavgiften för. Resor, mat, boende betalar du själv. Se vår tävlingskalender
						vilka tävlingar och läger som är prioriterade.
					</li>
				</ul>
				<br />
				<span>
			...
			<section>
				...
				<ul>
					...
					<li>Orange bälte = 4 KYU</li>
					<li>Grönt bälte = 3 KYU</li>
					<li>Blått bälte = 2 KYU</li>
			...
			<section>
				...
				<ul className="list-inside list-disc">
					...
					<li>Under träning är man tyst och lyssnar noga på tränaren. </li>
					<li>På mattan är man barfota med rena fötter. </li>
					<li>Naglar på fingrar och tår ska vara rena och kortklippta. </li>
					<li>Inga smycken på mattan. Ta av halsband, ringar, örhängen och armband. </li>
					<li>Du ska inte göra motstånd när din träningspartner ska öva in teknikerna. </li>
					<li>Inga svordomar på mattan. </li>
					<li>Inga sparkar eller slag mot varandra. </li>
					<li>Ingen lämnar mattan utan tränarens tillåtelse. </li>
					<li>Under träning byter man partner ofta så att alla kör med alla. </li>
					<li>Mobbning och trakasserier får inte förekomma i dojon </li>
				</ul>
			</section>
		</div>
	);
